...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-tribbe-charcoal text-white shadow hover:bg-tribbe-charcoal/90",
        destructive:
        ...
        ghost: "bg-transparent hover:bg-muted hover:text-accent-foreground border border-input",
        link: "text-primary underline-offset-4 hover:underline",
        gold: "bg-tribbe-gold text-white shadow hover:bg-tribbe-gold/90",
      },
      size: {

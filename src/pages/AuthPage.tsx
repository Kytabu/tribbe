            ...
            <div className="space-y-4 mt-32">
              ...
              <div className="flex justify-center gap-4 mt-4">
                <Button
                  variant="outline"
                  size="icon"
                  className="rounded-full w-12 h-12 bg-black hover:bg-black/90 border-0"
                  onClick={() => setIsVerifying(true)}
                >
                  <svg className="h-5 w-5" viewBox="0 0 48 48">
                    ...
                    <path fill="#4CAF50" d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.571c0.001-0.001,0.002-0.001,0.003-0.002l6.19,5.238C36.971,39.205,44,34,44,24C44,22.659,43.862,21.35,43.611,20.083z"></path>
                  </svg>
                </Button>
                <Button
                  variant="outline"
